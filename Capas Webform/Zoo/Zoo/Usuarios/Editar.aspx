<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="Zoo.Usuarios.Editar" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button ID="EditarBtn" Text="Guardar" runat="server" CssClass="btn btn-default" OnClick="Editar_Click" />
            </div>
        </div>
    </div>
    <div>
