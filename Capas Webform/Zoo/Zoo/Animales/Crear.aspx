<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Crear.aspx.cs" Inherits="Zoo.Animales.Crear" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label Text="Costumbres Alimenticias" runat="server" CssClass="control-label col-md-2" />
            <div class="col-md-10">
